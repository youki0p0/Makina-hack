  ...
  return (
    <div className="space-y-2">
      <div className="flex items-center justify-between">
        ...
        <span className="text-xs text-indigo-300">🔮 魂 {souls}</span>
      </div>
          ...
          return (
            ...
            >
              ...
              <button
                ...
                disabled={!canBuy}
                className="ml-2 shrink-0 rounded-lg bg-indigo-600 px-3 py-2 text-xs font-bold text-white active:scale-95 disabled:opacity-40"
              >
                {maxed ? "MAX" : `強化 🔮${cost}`}
              </button>
            </div>
