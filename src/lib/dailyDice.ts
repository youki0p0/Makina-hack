...
//   ⚔️ 攻めの目 … 💎ハイコイン/🪙ゴールド。大当たり = 💎ハイコイン1000
//   🛡️ 守りの目 … ★アップ素材（🔹欠片/🔶核）。大当たり = 💠刻印1
//   ✦ 運の目   … 🔮ガチャ/🎰コイン。大当たり = 🪽魂1
// ※💎ハイコイン1000 ≒ 💠刻印1 ≒ 🪽魂1（上位通貨どうしで等価）。🎰カジノコインは安通貨で運の目のフィラー。
...
export const DICE_FACES: readonly DiceFaceDef[] = [
  {
    ...
    rewards: [
      ...
      { kind: "hiCoins", amount: 100 },
      { kind: "gold", amount: 900 },
      { kind: "hiCoins", amount: 300 },
      { kind: "hiCoins", amount: 1000 }, // 大当たり（≒💠1・🪽1）
    ],
  },
  {
    id: "def",
