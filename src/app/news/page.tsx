...
const NOTES: Note[] = [
  {
    ...
    title: "やりこみに、ごほうびを",
    items: [
      "ゲームの隅々（隠し要素＝鬼連チャン・台パン出禁・無傷ボス撃破なども）を参照した108個の称号を実装。",
      "称号を獲得すると転生ポイント（0.5〜1）がもらえます。難しいほど太っ腹。",
      "もう遊んでくれている人には、達成済みの称号をこっそり遡及解除＆ポイント付与。今までの冒険、ちゃんと見てました。",
      "図鑑に「称号」タブを追加。隠し称号は ??? で、解放のお楽しみを残しつつ。",
    ],
  },
  {
    date: "2026-06-19",
